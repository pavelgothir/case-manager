    ...
    const FormsSpecificate = ({level})=>{
        ...
        <div className="set__modal__content__case  set__cont">  
            ...
            <h3>Івенти</h3>
                ...
                <label htmlFor="getEvent"><input defaultChecked={"getEvent" in level ? level.getEvent : false} type="checkbox" name="getEvent" id="getEvent" className="set__modal__content__common__className" /> Доступ до івенту (pro)</label>
